...
class ChatNuStrings {
  ...
  String get searchConversations => isPersian ? 'جست‌وجوی گفت‌وگوها' : 'Search conversations';
  ...
  String get newConversation => isPersian ? 'گفت‌وگوی جدید' : 'New conversation';
  String get newGroup => isPersian ? 'گروه جدید' : 'New group';
  String get encrypted => isPersian ? 'رمزگذاری سرتاسری' : 'End-to-end encrypted';
  ...
  String get mockMode => isPersian ? 'دادهٔ محلی — بدون اتصال به سرور' : 'Local data — server not connected';
  String get contactsSoon => isPersian ? 'جست‌وجوی واقعی مخاطبان در فاز اتصال API فعال می‌شود.' : 'Server-backed contact search arrives with the API migration.';
  String get settingsSoon => isPersian ? 'پوستهٔ تنظیمات واقعی ChatNU در این مسیر قرار می‌گیرد.' : 'The real ChatNU settings surface lives here during migration.';
  String get attachmentMock => isPersian ? 'پیوست در این فاز فقط نمای رابط کاربری است؛ آپلودی انجام نمی‌شود.' : 'Attachment controls are UI-only in this phase; nothing is uploaded.';
